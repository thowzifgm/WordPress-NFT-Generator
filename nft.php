...
/*plugin name: WordPress NFT Generator
...
<div class="row">
	<div class="col-md-12">
		<div id="contact-form" class="crown-form">
			<form id="form" action="../wp-content/plugins/wordpress-nft-generator/ajaxform.php" method="post" name="crown-form">
				...
				<div class="form-group submit_btnn">
					...
					<a class="btn btn-danger" href="../wp-content/plugins/wordpress-nft-generator/response.php'.@$_GET['page_id'].'" id="submit_form">Get All list</a>
				</div>
			</form>
